...
(() => {
  ...
  /* ---------- Promo bar rotation ---------- */
  const promoMessages = [
    "Premium American-made pickleballs — crafted in Georgia, USA",
    "Red, White & Blue 3-Pack ★ American pride, tournament spec — $5.99",
    "Best value: the MINA Package — both 3-packs for $8.99",
  ];
  ...
  form.addEventListener("submit", (e) => {
    ...
    form.reset();
    showToast("You're on the Dink List — welcome to Made in America ★");
  });
})();
